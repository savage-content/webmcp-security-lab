...
verify the result and closed authority. The five security lessons support that
story. Local Guard and reporting are future work outside the judged path and
must not appear in the contest demonstration. `PRIOR_ART.md` remains the claim
boundary.
...
4. continue the future Local Guard, reporting, and Android research only in a
   separate post-contest repository or fork until winners are announced.
