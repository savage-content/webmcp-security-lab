...
Collection digest: `sha256:287f14ac0928d7e15959fc29a249f4f8f5008bd2b44a656f3d52903e9ef4b13c`
...
| `E-RP-6`  | Fail-closed service configuration          | `products/reporting-service/config.ts`    | `440ec29c66321d7513f50b09fd0061cbe4fe39a4f4e4408201db7236e21a1184` |
| `E-RP-7`  | Role-separated service authentication      | `products/reporting-service/auth.ts`      | `216a4edb8e8a0d429ccee0e4ad8ed6124f484cf9af03ec4c7467832cdc347f65` |
...
| `E-RP-9`  | Durable optimistic D1 store                | `products/reporting-service/store.ts`     | `d684ebf8435cd31e4632c08879feb7b8402366e0ec7568a8afed2f01777e43c7` |
...
| `E-DOC-1` | Product acceptance and privacy boundary    | `docs/PRODUCT.md`                         | `66f6215f26596684e549e19a8c880847690265b083bc757d2f1fb8fe3ea0b290` |
| `E-DOC-2` | Current threat model                       | `docs/THREAT_MODEL.md`                    | `fc69c418fd872e0679f452dc1e8edcfb9de8b6f5991dfd5335540a94d5aeefa3` |
...
| `E-DOC-4` | Reporting service release boundary         | `docs/REPORTING_SERVICE.md`               | `9578e237d15d5be56451aa64c6ad6c33f283332f529da591bc3813d3214f58e3` |
...
retention/correction operation, latency benchmark, independent accessibility
participant, or retained screen-reader transcript was available. We therefore
keep product claims local and label deployment and operations as proposed.
