...
Collection digest: `sha256:6282ffc2dda9bf9a1500568f271c257808456ce61eef00cb966bf382b287a5b8`
...
| `E-RP-6`  | Fail-closed service configuration           | `products/reporting-service/config.ts`                 | `436ca7b0525955937de876b2c811493d13a80eb438d96541dbfb4c6399a0c539` |
| `E-RP-7`  | Role-separated service authentication       | `products/reporting-service/auth.ts`                   | `5d5d520d755e7161a4d4308bc4eb8df57f2cebb2c89b3b00c73239bcb14bfe41` |
...
| `E-RP-9`  | Durable optimistic D1 store                 | `products/reporting-service/store.ts`                  | `9b6129f592bbfd58384af022ac83594f1144320602529fee5096e5ce17f618cc` |
...
| `E-RP-22` | Bounded minimized JSON/NDJSON feed          | `products/reporting-service/feed.ts`                   | `52c6b4dac13ac71b1b6e5d3df2ceca5b791edd5a42711f092e274b479c995f1d` |
...
| `E-RP-10` | Durable reporting schema                    | `db/schema.ts`                                         | `3971267dcc8ad8e8b8f8131229a871db4e767bb0648802d5e5fe690520b38db1` |
...
| `E-DOC-1` | Product acceptance and privacy boundary     | `docs/PRODUCT.md`                                      | `db7bc8c1cd8ff95cf0422f268c5c73e7fd9000ab0aac67dca130c39d6182048e` |
| `E-DOC-2` | Current threat model                        | `docs/THREAT_MODEL.md`                                 | `9b772dc46789b8d7de86185c4ad76ea1f4cf4e7d99d6c70dfef35dc352b7f332` |
...
| `E-DOC-4` | Reporting service release boundary          | `docs/REPORTING_SERVICE.md`                            | `d3399bc7dae44e27ee442325bbf605dddafb0a56af2c354a5cf22790158f27a6` |
...
provider-backup purge, public-correction operation, latency benchmark,
independent accessibility participant, or retained screen-reader transcript was
available. Controlled private deletion is source-tested only. We therefore keep
product claims local and label deployment and operations as proposed.
