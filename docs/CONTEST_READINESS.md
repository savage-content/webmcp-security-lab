...
| Automated release gate                    | Fresh `npm ci` and Node.js 24 verification on September 2: 513/513 tests across 70 files; typecheck, readiness assessment, lint, and production build pass |
